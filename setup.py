...
setup(
    ...
    description="""Python implementation of the Gaussian peak detection
                   ...
                   See https://github.com/bnoi/peak_detection for details. Made installable and minor code updates by Vincent Hammer.""",
    long_description=open('README.md').read(),
    install_requires=install_requires,
    include_package_data=True,
    url='https://github.com/ViHammer/peak_detection/',
    classifiers=[
